<?php 
  ...
  $rutacategoria = $arrProducto['PRO_CAT_ID'].'/'.$arrProducto['CAT_RUTA'];
  ?>
<br><br><br>
<hr>
	<!-- breadcrumb -->
						  ...
						  ?>
								<div class="item-slick3" data-thumb="<?= $arrImages[$img]['url_image']; ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="<?= $arrImages[$img]['url_image']; ?>" alt="<?= $arrProducto['PRO_NOMBRE']; ?>">
						...
						<div class="p-t-33">
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									<button id="<?= openssl_encrypt($arrProducto['PRO_ID'],METHODENCRYPT,KEY); ?>" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail">
										Agregar al Carrito
									</button>
								</div>
							</div>	
