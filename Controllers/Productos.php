		...
		public function getProductos()
		{
			if($_SESSION['permisosMod']['PRM_R']){
				...
				for ($i=0; $i < count($arrData); $i++) {
					...
					if($arrData[$i]['PRO_STATUS'] == 1)
					{
						$arrData[$i]['PRO_STATUS'] = '<span class="badge badge-success">Activo</span>';
					}else{
						$arrData[$i]['PRO_STATUS'] = '<span class="badge badge-danger">Inactivo</span>';
					}

					$arrData[$i]['PRO_PRECIO'] = SMONEY.' '.formatMoney($arrData[$i]['PRO_PRECIO']);
					if($_SESSION['permisosMod']['PRM_R']){
					...
					if($_SESSION['permisosMod']['PRM_U']){
						$btnEdit = '<button class="btn btn-primary  btn-sm" onClick="fntEditInfo(this,'.$arrData[$i]['PRO_ID'].')" title="Editar producto"><i class="fas fa-pencil-alt"></i></button>';
					}
					if($_SESSION['permisosMod']['PRM_D']){	
						$btnDelete = '<button class="btn btn-danger btn-sm" onClick="fntDelInfo('.$arrData[$i]['PRO_ID'].')" title="Eliminar producto"><i class="far fa-trash-alt"></i></button>';
					}
