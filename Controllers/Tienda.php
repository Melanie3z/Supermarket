	...
	class Tienda extends Controllers{
		...
		public function producto($params){
			if(empty($params)){
				...
				$data['page_tag']   = NOMBRE_EMPRESA." - ".$infoProducto['PRO_NOMBRE'];
				$data['page_title'] = $infoProducto['PRO_NOMBRE'];
				$data['page_name']  = "producto";
				$data['producto']   = $infoProducto;
				$data['productos']  = $this->getProductosRandom($infoProducto['PRO_CAT_ID'],8,"r");
				...
				if(is_numeric($idproducto) and is_numeric($cantidad)){
					...
					if(!empty($arrInfoProducto)){
						$arrProducto = array('idproducto' => $idproducto,
											 'producto'   => $arrInfoProducto['PRO_NOMBRE'],
											 'cantidad'   => $cantidad,
											 'precio'     => $arrInfoProducto['PRO_PRECIO'],
